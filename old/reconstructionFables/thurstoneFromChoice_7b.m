...
% perceptual task, simple memory task
...
modelDir = './';
modelName = 'thurstoneFromChoice_7b';
...
for dataIdx = 1:numel(dataList)
   ...
   switch dataName
      ...
      case 'tomicBaysBoth'
         dataDir = 'data/';
         dataName = 'tomicBays';
         load([dataDir dataName], 'dp', 'dm');
         dataName = 'tomicBaysBoth';
   ...
   generator = @()struct('xS', rand(nTrialsP, 1));
   ...
   sigmaM = codatable(chains, 'sigmaM', @mean)
